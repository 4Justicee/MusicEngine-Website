...
$request->any('discover/genres', array('uses' => 'home@discover', 'secure' => false));
...
$request->any('api/{key}/get/trandingtag', array('uses' => 'api@trandingTag', 'secure' => false))->where(array('key' => '[a-zA-Z0-9\_\-]+'));
