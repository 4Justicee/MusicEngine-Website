        ...
        switch ($type) {
            case 'delete':
                if ($password = $this->request->input('password')) {
                    ...
                    if($uid == '')
                        $uid = $this->model('user')->authId;
                    $this->model('user')->delete($uid);
                    return json_encode(array(
                        'type' => 'url',
                        'value' => url(),
                ...
                $content = $this->view('user/settings/delete', array('uid'=>$uid));
                break;
            case 'blocked':
                ...
                $content = $this->view('user/settings/blocked', array('uid'=>$uid));
                break;
            case 'two-factor':
                if ($action = $this->request->input('action')) {
                ...
                $content = $this->view('user/settings/two-factor', array('uid'=>$uid));
                break;
            case 'password':
                if ($val = $this->request->input('val')) {
                    ...
                    if (!hash_check($current, $user['password'])) {
                        return json_encode(array(
                            'type' => 'error',
                            'message' => l('wrong-current-password')
                        ));
                    ...
                    $this->model('user')->changePasswordByUser($user, $new);
                    return json_encode(array(
                        'type' => 'success',
                        'message' => l('password-changed')
                    ));
                }
                $content = $this->view('user/settings/password', array('uid'=>$uid));
            ...
            case 'social':
                ...
                $content = $this->view('user/settings/social', array('uid'=>$uid));
                break;
            case 'notification':
                if($val = $this->request->input('val')) {
                    $uid = $this->request->input('uid');
                ...
                $content = $this->view('user/settings/notification', array('uid'=>$uid));
                break;
            case 'pro':
                $content = $this->view('user/settings/pro', array('uid'=>$uid));
                break;
            case 'profile':
                ...
                $content = $this->view('user/settings/profile', array('uid'=>$uid));
                break;
            default:
                ...
                if ($result['content']) {
                    ...
                    if($val = $this->request->input('val')) {
                        ...
                        if($validator->passes()) {  
                            ...
                            $this->model('user')->saveUserEdit($val, $user);
                            return json_encode(array(
                                'type' => 'success',
                                'message' => l('account-settings-saved')
                            ));
                    ...
                    $content = $this->view('user/settings/account', array('uid'=>$uid));
                }
                break;
        }
        return $this->render($this->view('user/settings/layout', array('type' => $type,'uid'=>$uid, 'content' => $content)), true);
    }
